...
function PetDetail() {
  ...
  return (
    <div>
      {platform != null ? <div style={{ backgroundColor: 'red' }}>功能演示, 平台{platform}</div> :
      ...
      <div>
        ...
        <button
          className="btn-info btn-xs btn bg-violet-500 hover:bg-violet-600 focus:outline-none focus:ring focus:ring-violet-300 active:bg-violet-700">
          原生tailwind
        </button>
      </div>
    </div>
