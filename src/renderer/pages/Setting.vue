				...
				<div v-for="(info, index) in pluginsConfigList" class="setting-container-item m-1">
					<div class="w-full">
						<div class="card w-64 bg-base-100 shadow-md">
							<div class="card-body">
                <div class="tooltip tooltip-top" :data-tip="info.name + '-' + info.version">
                  <div class="flex flex-row">
                    <div class="card-title truncate">{{ info.name }} - {{ info.version }}</div>
                  </div>
                </div>
                  ...
                  <div class="tooltip tooltip-top" data-tip="设置">
                    <div class="flex flex-row">
                      <svg
                  ...
                  <div class="tooltip tooltip-top" data-tip="更新插件">
                    <div class="flex flex-row">
                      <svg
                  ...
                  <div class="tooltip tooltip-top" data-tip="删除插件">
                    <div class="flex flex-row">
                      <svg
                  ...
                  <div class="tooltip tooltip-top" data-tip="是否开启插件">
                    <div class="flex flex-row">
                      <input
