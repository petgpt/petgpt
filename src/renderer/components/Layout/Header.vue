<template>
	<div class="ml-1 mb-1 flex flex-row items-center justify-between rounded-md bg-base-200 p-1.5 max-md:ml-0">
		<div>header</div>
    <select class="select select-sm ml-4 mr-4 w-full max-w-[8rem]">
...
const handleChangeTheme = () => {
	...
	html.dataset.theme = darkTheme === 'dark' ? 'light' : 'dark';
};
</script>
