<template>
  <div class="footer-first">
    ...
    <svg ref="clipBoardSvg" id="clipBoardSvg" @click="pasteToUserInput" fill="url(#gradient-horizontal)" style="cursor: pointer" t="1681979539030" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4501" width="17" height="17">
      <defs>
        <linearGradient id="gradient-horizontal" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stop-color="var(--color-stop-1)" />
        </linearGradient>
      </defs>
      <path d="M241.664 93.090909C241.664 93.090909 139.636364 93.090909 139.636364 194.280727c0 292.910545 0 728.529455 0 728.529455C139.636364 1024 241.664 1024 241.664 1024l540.672 0c0 0 102.027636 0 102.027636-101.189818L884.363636 194.280727C884.363636 93.090909 782.336 93.090909 782.336 93.090909l-82.804364 0 0 95.790545c0 15.080727-12.474182 27.322182-27.601455 27.322182L352.069818 216.203636c-15.220364 0-27.554909-12.241455-27.554909-27.322182L324.514909 93.090909 241.664 93.090909z" p-id="4502"></path>
      <path d="M605.090909 186.181818c0 0 46.545455 3.304727 46.545455-45.335273 0-48.64-46.545455-47.383273-46.545455-47.383273S606.813091 0 512 0C417.186909 0 418.909091 93.463273 418.909091 93.463273S372.363636 95.464727 372.363636 140.846545C372.363636 186.181818 418.909091 186.181818 418.909091 186.181818L605.090909 186.181818zM512 46.545455c25.693091 0 46.545455 20.852364 46.545455 46.545455S537.693091 139.636364 512 139.636364 465.454545 118.784 465.454545 93.090909 486.306909 46.545455 512 46.545455z" p-id="4503" fill="#515151"></path>
    </svg>
  ...
  <div class="footer-second">
    <el-input ref="userInputRef" :placeholder="placeHolder"
              ...
              v-model="userInput"
              @keydown.enter="chatTest" autofocus clearable></el-input>
...
@keyframes colorFlow {
  from{ --color-stop-1: rgb(96, 96, 96, 1); transform: translate(0%); }
  to{ --color-stop-1: #309AA9FF; transform: translate(100%); }
}
</style>
